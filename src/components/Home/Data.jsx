export default function Data() {
  return (
    <div className="home-data">
      ...
      <h3 className="home-subtitle">Backend Developer</h3>
      <p className="home-description">
        My software development journey began with C language in my final year of high school. In addition to my studies, I also worked at 42 Istanbul in the software development field. There, I was introduced to Linux and terminal commands. After reaching a certain level, I developed a strong interest in backend development. I’m a recent computer engineer. During my internship, I developed backend services using Go and was directly involved in company projects. I used PostgreSQL and Redis. I also implemented various projects using Node.JS. During my first two years of school, I dabbled in various languages, including Python and C#. In the mobile world, I previously developed the framework for a TV series/movie application using Kotlin and Android Studio. I’m extremely open to learning and developing. I want to deepen my knowledge and contribute to the software field, particularly in backend and system architecture.
      </p>
    </div>
  );
}
